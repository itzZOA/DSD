...
class Iface:
  ...
  def suma(self, num1, num2, num3, num4):
    """
    Parameters:
     - num1
     - num2
  ...
  def resta(self, num1, num2, num3, num4):
    """
    Parameters:
     - num1
     - num2
  ...
  def multiplicacion(self, num1, num2, num3, num4):
    """
    Parameters:
     - num1
     - num2
  ...
  def division(self, num1, num2, num3, num4):
    """
    Parameters:
     - num1
     - num2
...
class Client(Iface):
  ...
  def suma(self, num1, num2, num3, num4):
    ...
    Parameters:
     ...
     - num4
    """
    self.send_suma(num1, num2, num3, num4)
    return self.recv_suma()

  def send_suma(self, num1, num2, num3, num4):
  ...
  def resta(self, num1, num2, num3, num4):
    ...
    Parameters:
     ...
     - num4
    """
    self.send_resta(num1, num2, num3, num4)
    return self.recv_resta()

  def send_resta(self, num1, num2, num3, num4):
  ...
  def multiplicacion(self, num1, num2, num3, num4):
    ...
    Parameters:
     ...
     - num4
    """
    self.send_multiplicacion(num1, num2, num3, num4)
    return self.recv_multiplicacion()

  def send_multiplicacion(self, num1, num2, num3, num4):
  ...
  def division(self, num1, num2, num3, num4):
    ...
    Parameters:
     ...
     - num4
    """
    self.send_division(num1, num2, num3, num4)
    return self.recv_division()

  def send_division(self, num1, num2, num3, num4):
...
class Processor(Iface, TProcessor):
  ...
  def process_suma(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = suma_result()
    result.success = self._handler.suma(args.num1, args.num2, args.num3, args.num4)
  ...
  def process_resta(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = resta_result()
    result.success = self._handler.resta(args.num1, args.num2, args.num3, args.num4)
  ...
  def process_multiplicacion(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = multiplicacion_result()
    result.success = self._handler.multiplicacion(args.num1, args.num2, args.num3, args.num4)
  ...
  def process_division(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = division_result()
    result.success = self._handler.division(args.num1, args.num2, args.num3, args.num4)
...
class suma_args:
  ...
  thrift_spec = (
    ...
    (3, TType.I32, 'num3', None, None, ), # 3
    (4, TType.I32, 'num4', None, None, ), # 4
  )

  def __init__(self, num1=None, num2=None, num3=None, num4=None,):
    self.num1 = num1
    self.num2 = num2
    self.num3 = num3
    self.num4 = num4
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I32:
          self.num3 = iprot.readI32();
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.I32:
          self.num4 = iprot.readI32();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.num3 is not None:
      oprot.writeFieldBegin('num3', TType.I32, 3)
      oprot.writeI32(self.num3)
      oprot.writeFieldEnd()
    if self.num4 is not None:
      oprot.writeFieldBegin('num4', TType.I32, 4)
      oprot.writeI32(self.num4)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
